...
<html lang="en">
                            ...
                            <div class="row panel panel-default align-items-center" style="opacity: 0.8;">
                                ...
                                <div class="row " id="gpayhide">
                                    ...
                                    <div class="col-md-6 mb-3" style="padding-left: 40px;">
                                        <label for="mobilennum">Mobile Number</label>
                                        <input type="text" class="form-control" id="gpaymobilenum"  value="" required>
                                        <div class="invalid-feedback">
                                            Valid Mobile number is required.
                                        </div>
                                    </div>
                                ...
                                <div class="row" id="zellehide">
                                    <div class="col-12 text-black text-center mb-2">
                                        <b class="text-danger">Important ! Do not put anything in Zelle notes but Your name.</b>
                                        <br>
                                    ...
                                    <div class="col-md-6 mb-3"  style="padding-left: 40px;">
                                        ...
                                        <input type="text" class="form-control" id="zellemobilenum" value="" required>
                                        <div class="invalid-feedback">
                                            Valid Mobile number is required.
                                        </div>
                                    </div>
                                ...
                                <div class="row" id="creditcardhide"  style="padding-left: 40px;">
                                    ...
                                    <div class="col-6 col-md-6 mb-3">
                                        ...
                                        <input type="text" onchange="checkCreditCard()" class="form-control" id="creditcardnum"  required="">
    ...
    <script>
        function checkCreditCard() {
            var x = document.getElementById("creditcardnum").value;
            var cardnoo = /^[0-9]{16}$/;
            if (x.match(cardnoo)) {
                $("#creditcardnum").on('change', function (e) {
                    var val = $(this).val();
                    var newval = '';
                    val = val.replace(/\s/g, '');
